...
export const RESUME = {
  introduce: {
    ...
    category: [
      {
        title: '디자인',
        text: '개인 작업에서 직접 디자인하고 UX/UI를 고려하여 개발하는 것을 좋아합니다. 그 과정 속에서 UI 개발과 디자인의 프로세스를 이해하고 개선점을 찾기위해 노력합니다.',
      },
      {
        title: 'TMI',
    ...
    category: [
      {
        ...
        items: [
          ...
          'styled-components 와 emotion과 같은 CSS in Js 라이브러리를 사용하여 스타일링을 하는 것을 선호합니다.',
        ],
      },
      {
        title: 'Javascript',
        items: [
          'VanilaJs에 익숙하고 es5부터의 문법을 사용할 수 있습니다.',
      ...
      },
      {
        ...
        items: [
          ...
          'Record, Partial 등 과 같은 유틸리티 타입을 사용할 수 있으며, 더 좋은 타입스크립트 사용을 위해서 계속해서 공부 중에 있습니다.',
        ],
      },
      {
        title: 'React',
        items: [
          ...
          'Redux 나 Recoil 라이브러리로 전역 상태 관리를 할 수 있습니다.',
          'styled component 나 emotion를 사용해서 공통 테마 및 스타일을 작성할 수 있습니다.',
        ...
        items: [
          {
            ...
            inform:
              '간편하게 배차 가능한 기업 맞춤 화물 운송 서비스를 구축부터 배포까지 프론트엔드 개발을 단독으로 맡게되어 진행하였습니다. 첫 React를 사용하여 제작한 서비스이며 처음 시도해 보는 기능들이 많았지만 차근차근 해결해 나가 많은 것을 배울 수 있었던 프로젝트이고 신경 쓰지 못했던 부분도 많아 아쉬움이 남습니다. 클라이언트와 원만한 소통을 하고 개선할 수 있는 부분이 있으면 제시하여 프로젝트의 방향을 좋게 이끌어 갔던 경험도 있습니다.',
            items: [
